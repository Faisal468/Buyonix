      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-4">Virtual Try-On</h3>
            <p className="text-gray-600 mb-6">
              Upload your photo and see exactly how products will look on you before making a purchase. Our AI technology ensures accurate visualization.
            </p>
